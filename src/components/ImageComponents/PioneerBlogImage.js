...
const PioneerBlogImage = () => (
  <StaticQuery
    query={graphql`
      query {
        file(relativePath: { eq: "products/pioneer-blog.jpg" }) {
          childImageSharp {
            fluid(maxWidth: 200) {
    ...
    render={data => {
      ...
      return (
        <StyledImage
          fluid={image.fluid}
          alt="Illustration eines Mannes der in die Kamera guckt mit Mediapioneer-Logo"
        />
      )
    }}
  />
)
export default PioneerBlogImage
